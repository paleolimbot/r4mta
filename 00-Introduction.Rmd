...
To make learning R visualization more fun, we will also load a package called "unienrollment" in all of our exercises.

```{r}
# I've already installed the "unienrollment" package on this server
# So all you need to do is load it
